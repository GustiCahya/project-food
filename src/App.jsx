...
import "./App.css";
import { Account, Contract, Footer, GasGauge, Header, ThemeSwitch } from "./components";
...
import CreateOffer from "./views/pages/CreateOffer";
import Signup_2 from "./views/pages/Signup_2";
import Signup_1 from "./views/pages/Signup_1";
...
document.title = `mmmint (${targetNetwork.name.replace('host','').charAt(0).toUpperCase() + targetNetwork.name.replace('host','').substr(1).toLowerCase()})`;
